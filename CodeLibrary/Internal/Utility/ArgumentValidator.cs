...
namespace CodeLibrary.Internal.Utility
{
    ...
    internal static class ArgumentValidator
    {
        ...
        public static void NotNullOrEmptyString(string argumentValue, string argumentName)
        {
            ...
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, CodeLibrary.SR.ArgumentValidator_NotNullOrEmptyString, argumentName));
            }
        }
        ...
        public static void EnumValueIsDefined(Type enumType, object value, string argumentName)
        {
            if (Enum.IsDefined(enumType, value) == false)
            {
                throw new ArgumentException(String.Format(CultureInfo.CurrentCulture,
                   CodeLibrary.SR.ArgumentValidator_EnumValueIsDefined,
        ...
        public static void TypeIsAssignableFromType(Type assignee, Type providedType, string argumentName)
        {
            ...
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture,
                    CodeLibrary.SR.ArgumentValidator_TypeIsAssignableFromType, assignee, providedType), argumentName);
            }
        }
    }
}
